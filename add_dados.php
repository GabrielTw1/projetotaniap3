...
$orgao=isset($_POST['profissao']) ? $_POST['profissao'] : '';
...
$insert = "INSERT INTO usabilidade (nome, cpf, rg, orgao, profissao,
titulo, estado_civil, nascimento, sexo, rua_cont, num_cont, bairro_cont,cidade_cont, uf_cont, cep_cont, telefone_cont,
celular, email, escolaridade, rendimento, membros, fantasia, razao, cnpj, cod_acesso, recibo, rua_emp, num_emp, bairro_emp, cidade_emp, uf_empresa, cep_empresa, tel_emp, email_emp, gera, valor, segmento, data_abertura, funcionarios, demanda "
VALUES ()
